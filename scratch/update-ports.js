...
// 1. Update gateway expose, ports, environment, and healthcheck
...
// 3. Update assessment-web configs
content = content.replace(/ports:\r?\n\s*-\s*"127.0.0.1:3002:3000"/g, 'ports:\r\n      - "127.0.0.1:8082:8082"');

// 4. Update NestJS services expose, PORT and environment definitions
const services = {
  auth: 3020,
  profile: 3030,
  organisation: 3040,
