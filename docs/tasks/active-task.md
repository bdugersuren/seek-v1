...
- Бодит file object storage upload хийхгүй; энэ task дээр document metadata болон future storage boundary бэлдэнэ.
- Бодит SMS/OTP provider холбохгүй; phone verification field/status болон provider boundary бэлдэнэ.
...
2. `TODO` Profile Domain Contract Finalization
...
3. `TODO` Prisma Schema and Migration
...
4. `TODO` Completion Policy Module
...
9. `TODO` Gateway Integration and RBAC
...
10. `TODO` Portal Profile Integration
...
11. `TODO` Portal Verification and Documents UX
...
12. `TODO` Production Mock Cleanup
